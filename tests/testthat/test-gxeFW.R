...
test_that("anova table is correct", {
  expect_equal(as.numeric(as.matrix(geFw0$anova)),
               c(14, 2, 14, 59, 89, 11901.6249899836, 9.55053113096801,
                 6771.97406517297, 35837.6702256662, 54520.8198119537,
                 850.116070713112, 4.77526556548401, 483.71243322664,
                 607.418139418072, 612.593481033188, 1.39955660778842,
                 0.00786157879654184, 0.79634176498261, NA, NA,
                 0.182343051582967, 0.992170281738418, 0.669153553775784,
                 NA, NA))
})
